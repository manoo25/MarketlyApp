...
<View style={{justifyContent:'space-between',flexDirection:'row',width:'100%'}}>
   <Text style={[styles.h3, { marginTop: 10, fontSize: 20, color: '#7B7686',marginRight:8 }]}>
                    {specificProduct[0]?.quantity_per_unit} قطعة
                  </Text>

                   <Text style={[styles.h3, { marginTop: 10, fontSize: 20, color: colors.BtnsColor }]}>
                   
                 
                 <Text style={{color:'#7B7686'}}>  سعر القطعة : </Text>
                   <Text >  {(specificProduct[0]?.endPrice/specificProduct[0]?.quantity_per_unit).toFixed(2)}</Text>
                <Text >ج.م </Text>
      ...
      <View style={{ width: "100%", paddingHorizontal: 10, paddingTop: 10, backgroundColor: 'white', borderTopWidth: 1, borderTopColor: '#EFECF3' }}>
        <View
          style={{
            alignSelf: "stretch",
            paddingBottom: 15,
